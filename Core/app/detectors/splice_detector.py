...
class SpliceDetector:
    def __init__(self, n_fft: int = 2048, hop_length: int = 1024, discontinuity_threshold: float = 0.75):
        self.n_fft = n_fft
    ...
    def analyze(self, audio_path: str) -> DetectionResult:
        ...
        return DetectionResult(
            ...
            description=f"Найдено {len(markers)} точек склейки. Хроматических скачков: {chroma_jumps}. CV rolloff: {rolloff_cv:.3f}",
            markers=markers,
            additional_data={
