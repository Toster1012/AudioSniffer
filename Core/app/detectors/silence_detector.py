...
class SilenceDetector:
    def __init__(self, top_db: float = 35.0, min_silence_duration: float = 0.25, max_natural_silence: float = 2.5):
        self.top_db = top_db
    ...
    def analyze(self, audio_path: str) -> DetectionResult:
        ...
        return DetectionResult(
            ...
            description=f"Обнаружено {total} пауз, {suspicious_count} подозрительных. Вариативность динамики: {rms_cv:.2f}",
            markers=markers,
            additional_data={
